        ...
        if self.if_redBool() == '+xy':
                ...
                for col in range(col_num):
                    if col == 0:
                        if row == 0:
                            ...
                            mc.move(hgt[0], hgt[1], hgt[2], obj_lis[obj_n][0], r = True)
                            #mc.setAttr('{}.translate'.format(obj_lis[obj_n][0]), 0, 0, row_hgt[row])
                        move_x = obj_lis[obj_n][2] + ivl_num
                        obj_n += 1
                    else:
                        if row == 0:
                            ...
                            hgt_num = row_hgt[row]
                            hgt = [(obj_abs[obj_lis[obj_n][0]][0] - (move_x + obj_lis[obj_n][2])) * (-1), obj_abs[obj_lis[obj_n][0]][1] * (-1), (obj_abs[obj_lis[obj_n][0]][1] - hgt_num) * (-1)]
                        mc.move(hgt[0], hgt[1], hgt[2], obj_lis[obj_n][0], r = True)
                        #mc.setAttr('{}.translate'.format(obj_lis[obj_n][0]), move_x + obj_lis[obj_n][2], 0, hgt_num)
                        move_x = mc.getAttr("{}.translateX".format(obj_lis[obj_n][0])) + obj_lis[obj_n][2] + ivl_num
                        obj_n += 1
            ...
            if len(rema_obj) > 0:
                ...
                for inf in range(len(rema_obj)):
                    ...
                    if inf == 0:
                        mc.move(hgt[0], hgt[1], hgt[2], rema_obj[inf][0], r = True)
                        #mc.setAttr('{}.translate'.format(rema_obj[inf][0]), 0, 0, rema_hgt)
                        rema_moveX = rema_obj[inf][2] + ivl_num
                    else:
                        mc.move((obj_abs[rema_obj[inf][0]][0] - (rema_moveX + rema_obj[inf][2])) * (-1), hgt[1], hgt[2], rema_obj[inf][0], r = True)
                        #mc.setAttr('{}.translate'.format(rema_obj[inf][0]), rema_moveX + rema_obj[inf][2], 0, rema_hgt)
                        rema_moveX = mc.getAttr('{}.translateX'.format(rema_obj[inf][0])) + rema_obj[inf][2] + ivl_num
